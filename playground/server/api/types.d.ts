...
export interface Input2 { status:string; nextId:string; 'orderId': string; }
...
export type Input8 = {'pid': string;'name': string;'variantId': string;}& { viewId:string; isActive:boolean; age:number; } | { nextId:string; outerId:string; }

export interface Input9 { prevId:string; age:number; price:number; 'userId': string; }

export type Input10 = {'variantId': string;}& { price:number; createdAt:string; } | { count:number; status:string; }

export type Input11 = {'pid': string;'categoryId': string;}& { outerId:string; status:string; email:string; } | { createdAt:string; age:number; }
...
export interface Input15 { updatedAt:string; createdAt:string; 'variantId': string; 'categoryId': string; }

export interface Input16 { count:number; email:string; 'pid': string; 'categoryId': string; }

export interface Input17 { email:string; updatedAt:string; 'id': string; 'uid': string; }

export interface Input18 { createdAt:string; prevId:string; slug: string; orderId: string; }
...
export type Input24 = {'uid': string;'postId': string;'variantId': string;}& { isActive:boolean; nextId:string; } & { age:number; itemId:string; }
